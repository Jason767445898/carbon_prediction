...
"""
煤炭价格预测 - 第五轮参数优化
基于第四轮失败经验,探索架构简化和新优化方向
核心策略: 简化LSTM层数 + 调整序列长度 + 优化batch size + 回归稳定单头Attention
"""
...
# 参数搜索空间 - 探索简化和新方向
PARAM_GRID = [
    # 配置1: 2层LSTM(384-192) - 简化架构
    {
        'name': 'Round5_Config1_2LayerLSTM_384',
        'sequence_length': 60,
        'lstm_units': 384,
        'lstm_units_2': 192,
    ...
    # 配置2: 2层LSTM(512-256) - 更大容量
    {
        'name': 'Round5_Config2_2LayerLSTM_512',
        'sequence_length': 60,
        'lstm_units': 512,
        'lstm_units_2': 256,
        'lstm_units_3': 0,
...
def run_optimization():
    ...
    output_path = f'/Users/Jason/Desktop/code/AI/parameter/coal_price_optimization_round5_{timestamp}.xlsx'
    ...
    with pd.ExcelWriter(output_path, engine='openpyxl') as writer:
        ...
        top3 = results_df.head(3)[['config_name', 'R2', 'RMSE', 'MAPE', 
                                    ...
                                    'lstm_units', 'lstm_units_2', 'lstm_units_3',
                                    'batch_size', 'epochs']]
    ...
    print("="*80)
    print(f"第五轮优化完成! 最佳R² = {results_df.iloc[0]['R2']:.4f}")
