...
# 🔥 第四轮优化配置 - 20个配置
# 基于第三轮最优结果: Config_07 (R²=0.4588, RMSE=63.15), Config_04 (MAE=45.83)
# 优化策略：在最优架构附近精调，探索单层大容量LSTM与短序列组合
OPTIMIZATION_CONFIGS = [
    # 组1: 在Config_07附近精调 - 单层大容量LSTM (配置1-5)
    {
        'name': 'Config_01_LSTM92_Attn62',
        'sequence_length': 42,
        'lstm_units': [92],
        'attention_dim': 62,
        'dense_units_1': 54,
    ...
    # 组2: 结合Config_04短序列优势 (配置6-10)
    {
        'name': 'Config_06_Seq30_LSTM96',
        'sequence_length': 30,
        'lstm_units': [96],
        'attention_dim': 64,
        'dense_units_1': 56,
    ...
    # 组3: 超大容量单层LSTM (配置11-15)
    {
        'name': 'Config_11_LSTM120_Seq40',
        'sequence_length': 40,
        'lstm_units': [120],
        'attention_dim': 76,
        'dense_units_1': 60,
    ...
    # 组4: 三层浅层LSTM网络 (配置16-18)
    {
        'name': 'Config_16_ThreeLayer_48_24_12',
        'sequence_length': 35,
        'lstm_units': [48, 24, 12],
        'attention_dim': 48,
        'dense_units_1': 48,
    ...
    {
        'name': 'Config_17_ThreeLayer_56_28_14',
        'sequence_length': 30,
        'lstm_units': [56, 28, 14],
        'attention_dim': 52,
        'dense_units_1': 52,
    ...
    {
        'name': 'Config_18_ThreeLayer_64_32_16',
        'sequence_length': 38,
        'lstm_units': [64, 32, 16],
        'attention_dim': 56,
        'dense_units_1': 56,
    ...
    # 组5: 最优组合探索 (配置19-20)
    {
        'name': 'Config_19_Ultimate_Hybrid',
        'sequence_length': 32,
        'lstm_units': [98],
        'attention_dim': 65,
        'dense_units_1': 56,
...
OUTPUT_DIR = 'outputs/optimization_round4'
...
def run_optimization():
    print("="*80)
    print(" " * 20 + "煤炭价格预测 - 第四轮参数优化")
    print("="*80)
    print(f"开始时间: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print(f"配置数量: {len(OPTIMIZATION_CONFIGS)}")
    print(f"基准性能: R³轮最优 R²=0.4588, RMSE=63.15, MAE=45.83")
    print(f"目标性能: R²>0.50, RMSE<60, MAE<45")
    ...
    for idx, opt_config in enumerate(OPTIMIZATION_CONFIGS, 1):
        ...
        config_folder = os.path.join('parameter', f'round4_config_{idx:02d}')
